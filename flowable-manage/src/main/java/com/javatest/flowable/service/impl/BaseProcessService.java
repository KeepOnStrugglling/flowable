 ...
 * @date : 2019/12/220:50
 *
 * @description: Javen：将共性的service合并到一个父Service中
 */
public abstract class BaseProcessService {
    ...
    @Autowired
    private BaseProcessDao baseProcessDao;
    ...
    protected void deleteActivity(String disActivityId, String processInstanceId) {
        ...
        if (CollectionUtils.isNotEmpty(disActivities)) {
            ...
            if (CollectionUtils.isNotEmpty(datas)) {
                ...
                baseProcessDao.deleteRunActinstsByIds(runActivityIds);
                baseProcessDao.deleteHisActinstsByIds(runActivityIds);
            }
        }
    }
